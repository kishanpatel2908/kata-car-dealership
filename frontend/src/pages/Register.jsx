...
export default function Register() {
    ...
    return (
        ...
        <button
        type="submit"
        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg uppercase tracking-widest transition shadow-lg shadow-blue-900/20 mt-2"
        >
        Create Account
        </button>
        </form>
